...
install_packages="postfix postfix-sqlite dovecot-imapd dovecot-pop3d dovecot-lmtpd dovecot-sieve dovecot-sqlite sqlite3 opendkim opendkim-tools spamassassin spamc net-tools fail2ban bind9-host"
...
emailwizctl system init --certificate-mode "$certificate_mode"
